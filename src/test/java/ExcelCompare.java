...
public class ExcelCompare {
    public static void main(String[] srgs) throws IOException {
        ...
        FileInputStream fileInputStream1 = new FileInputStream("/Users/adelgamal/eclipse-workspace/TestATAF/B0 After ICC.xlsx");

        HSSFWorkbook workbook1 = new HSSFWorkbook(fileInputStream1);

        HSSFSheet worksheet1 = workbook1.getSheet("/Users/adelgamal/eclipse-workspace/TestATAF/B0 Before ICC.xlsx");

        int rowCount1= worksheet1.getPhysicalNumberOfRows();


        FileInputStream fileInputStream2 = new FileInputStream("B0 Before ICC.xlsx");

        HSSFWorkbook workbook2 = new HSSFWorkbook(fileInputStream2);

        HSSFSheet worksheet2 = workbook2.getSheet("B0 After ICC");
